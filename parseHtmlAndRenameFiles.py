...
class ParseAndRename:
    ...
    def changeDir(self):
        os.chdir(r'C:\Users\10264628\Desktop\NEXT ARG Presentation\pdfDoc_1')

    def rename(self):
        for filename in os.listdir(r'C:\Users\10264628\Desktop\NEXT ARG Presentation\pdfDoc_1'):
